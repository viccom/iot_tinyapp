...
func main() {
	...
	myMapNamespace1 := server.NewMapNamespace(s, "MyTestNode")
	...
	myMapNamespace1.Data["CurrentTime"] = time.Now()
	...
	go func() {
		...
		for {
			...
			myMapNamespace1.Data["Tag1"] = randomFloat
			myMapNamespace1.ChangeNotification("Tag1")
			num++
			myMapNamespace1.Data["Tag2"] = num
			myMapNamespace1.ChangeNotification("Tag2")
			myMapNamespace1.Data["CurrentTime"] = time.Now()
			myMapNamespace1.ChangeNotification("CurrentTime")
